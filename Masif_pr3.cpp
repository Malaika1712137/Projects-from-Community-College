...
int main()
{
    ...
    //setw(n) is used to display the output in specific order
    cout << "Hotel Income is: $" << setw(5) << HotelIncome << endl;
    cout << "Occupied Rooms are: " << setw(5) << totalOccupied << endl;
    cout << "Unoccupied Rooms are:" << setw(5) << unOccupied << endl;
